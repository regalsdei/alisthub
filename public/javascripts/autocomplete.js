...
angular.module('google.places', [])
  ...
  .directive('gPlacesAutocomplete',
            ...
            return {
                ...
                link: function ($scope, element, attrs, controller) {
                    ...
                    function initAutocompleteDrawer() {
                        ...
                        var drawerElement = angular.element('<div data-tap-disabled="true" g-places-autocomplete-drawer></div>'),
    ...
    .directive('gPlacesAutocompleteDrawer', ['$window', '$document', function ($window, $document) {
        var TEMPLATE = [
            '<div class="pac-container" data-tap-disabled="true" ng-if="isOpen()" ng-style="{top: position.top+\'px\', left: position.left+\'px\', width: position.width+\'px\'}" style="display: block;" role="listbox" aria-hidden="{{!isOpen()}}">',
    ...
    .directive('gPlacesAutocompletePrediction', [function () {
        var TEMPLATE = [
            ...
            '<span class="pac-item-query" data-tap-disabled="true" ng-bind-html="prediction | highlightMatched"></span>',
